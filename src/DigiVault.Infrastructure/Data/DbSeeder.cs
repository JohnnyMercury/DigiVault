    ...
    public static async Task SeedAsync(IServiceProvider serviceProvider)
    {
        ...
        if (!await context.GiftCards.AnyAsync())
        {
            context.GiftCards.AddRange(
                ...
                new GiftCard { Name = "Netflix", Slug = "netflix", Description = "Подарочные карты Netflix", Icon = "🎬", ImageUrl = "/minio/digivault-images/products/netflix.svg", Gradient = "linear-gradient(135deg, #8b0000, #e50914)", Category = GiftCardCategory.Streaming, SortOrder = 1 },
