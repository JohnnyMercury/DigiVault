        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorRole = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    GameId = table.Column<int>(type: "integer", nullable: true),
                    GiftCardId = table.Column<int>(type: "integer", nullable: true),
                    VpnProviderId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductReviews_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductReviews_GiftCards_GiftCardId",
                        column: x => x.GiftCardId,
                        principalTable: "GiftCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductReviews_VpnProviders_VpnProviderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_GameId",
                table: "ProductReviews",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_GiftCardId",
                table: "ProductReviews",
                column: "GiftCardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviews_VpnProviderId",
                table: "ProductReviews",
